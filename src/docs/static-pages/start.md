...
```
<link rel="stylesheet" type="text/css" href="https://unpkg.com/fiori-fundamentals@1.4.0/dist/fiori-fundamentals.min.css">
```
...
You can now use the [Playground](https://dist-9gvg7mey1.now.sh) to browse the components currently available with Fundamental Vue.
